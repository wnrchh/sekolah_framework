...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="services" style="margin-top:75px">
    <button class="btn btn-success btn-sm"><a href="<?=base_url()?>siswa/form_siswa">Tambah</a></button>
...
?>
	...
	<tr>
		...
		<td><button><a href="<?=base_url()?>siswa/hapus/<?php echo $value->id; ?>">Hapus</a></button><br>
		<button><a href="<?=base_url()?>siswa/edit/<?php echo $value->id; ?>">Edit</a></button></td>
	</tr>
