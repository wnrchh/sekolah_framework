...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <h1 class="w3-jumbo"><b>Data Karyawan</b></h1>
  ...
  <div class="w3-container" id="services" style="margin-top:75px">
    <button class="btn btn-success btn-sm"><a href="<?=base_url()?>karyawan/form_karyawan">Tambah</a></button>
...
?>
	...
	<tr>
		...
		<td><button><a href="<?=base_url()?>karyawan/hapus/<?php echo $value->id; ?>">Hapus</a></button><br>
		<button><a href="<?=base_url()?>karyawan/edit/<?php echo $value->id; ?>">Edit</a></button></td>
	</tr>
